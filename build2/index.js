...
var button = document.querySelector('.sidebar-menu__button_imd-main');
...
var mobileButton = document.querySelector('.sidebar-mobile-burger');
var sidebarMenu = document.querySelector('.main-content');
